...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "🔥 <b>УНІКАЛЬНА ПРОПОЗИЦІЯ — ТІЛЬКИ ТУТ!</b>\n"
        "Якщо ви зберете всі документи за <b>31 день</b> — ваша ціна на послуги АК складе лише "
        "<b>12 500 грн</b>. Такої ціни немає ніде! Це найнижча можлива ціна — "
        "ексклюзивно для тих, хто діє швидко! ⚡️\n\n"
...
async def handle_screening_answer(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.message.reply_text(
        ...
        f"Зберіть усі документи протягом <b>31 дня</b> з моменту реєстрації — і ваша ціна на "
        f"послуги АК складе лише <b>12 500 грн</b>. Це найнижча ціна, якої немає ніде!\n\n"
        f"Успіхів! 💪",
        parse_mode='HTML',
        reply_markup=get_main_keyboard()
    )
        ...
        if old_status != 'completed':
            ...
            if days_since_reg <= 31:
                ...
                message += (
                    ...
                    f"🏆 <b>ВИ ОТРИМАЛИ БОНУС!</b>\n"
                    f"Ви зібрали всі документи за {days_since_reg} днів — це рекордний результат! ⚡️\n\n"
                    f"💰 Ваша ціна на послуги АК — лише <b>12 500 грн</b>.\n"
                    f"Це найнижча можлива ціна — ексклюзивно для найшвидших!\n\n"
